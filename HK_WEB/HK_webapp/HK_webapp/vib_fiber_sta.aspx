<%@ Page Language="C#" MasterPageFile="~/NavMaster.master" AutoEventWireup="true" CodeBehind="vib_fiber_sta.aspx.cs" Inherits="HK_webapp.vib_fiber_sta" %>

<asp:Content ID="Vib_Fiber_Content" ContentPlaceHolderID="RightContent" runat="Server">
    ...
    <div id="top_band" style="background-color:bisque">
        <table>
            <tr>
                ...
                <td>| &nbsp;&nbsp <asp:HyperLink ID="HyperLink_VibMain" runat="server"  Font-Underline="True" ForeColor="blue" Text=" 返回振动主页" NavigateUrl="vibmain.aspx"></asp:HyperLink>&nbsp;&nbsp</td> 
    ...
    <h3>&nbsp;&nbsp;&nbsp<font color="blue">光纤状态历史数据查询</font></h3>
                     ...
                     <tr>
                         ...
                         <td> 
                             ...
                             <tr style="width:1100px">
                                 ...
                                 <td valign="top">
                                     <asp:Panel ID="Panel_sta" runat="server">
                                     光纤状态: 
                                     <asp:DropDownList ID="DropDownStatus" runat="server" Width="65" >
                                         <asp:ListItem Value="0">所有</asp:ListItem>
                                         <asp:ListItem Value="1">断纤</asp:ListItem>
                                         <asp:ListItem Value="2">光纤拔出</asp:ListItem>   
                                         <asp:ListItem Value="3">光纤过长</asp:ListItem> 
                                         <asp:ListItem Value="4">光纤正常</asp:ListItem>
                                     </asp:DropDownList>
                                 ...
                                 <td valign="top">
                                     ...
                                     是否已确认: 
                                     <asp:DropDownList ID="DropDownConfirm" runat="server" Width="65" >
                                         <asp:ListItem Value="0">所有</asp:ListItem>
           ...
           <tr>
              ...
              <td>
                 ...
                 <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataKeyNames="id"
                    ...
                    <Columns>
                        <asp:BoundField DataField="id" HeaderText="编号" SortExpression="id" ItemStyle-Width="140" >
                            <ItemStyle HorizontalAlign="Center" Width="140px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="push_time" HeaderText="报警时间" 
                            SortExpression="push_time" ItemStyle-Width="270" 
                            ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center" Width="270px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="channel_id" HeaderText="通道号" 
                            SortExpression="channel_id" ItemStyle-Width="170" 
                            ItemStyle-HorizontalAlign="Center" >
                            <ItemStyle HorizontalAlign="Center" Width="170px" />
                        </asp:BoundField>

                        <asp:BoundField DataField="fiber_real_len" HeaderText="报警点" 
                            SortExpression="fiber_real_len" ItemStyle-Width="190">
                            <ItemStyle HorizontalAlign="Center" Width="190px" />
                        </asp:BoundField>

                       <asp:BoundField DataField="fiber_stat" HeaderText="光纤状态" 
                            SortExpression="fiber_stat" ItemStyle-Width="220">
                            <ItemStyle HorizontalAlign="Center" Width="220px" />
                        </asp:BoundField>

               
                        <asp:BoundField DataField="show_check" HeaderText="是否已确认" 
                            SortExpression="event_width" ItemStyle-Width="180" 
                            ItemStyle-HorizontalAlign="Center">
