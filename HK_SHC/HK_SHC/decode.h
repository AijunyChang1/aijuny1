...
int decode_msg(char* msgbuf, int len, RecvInfo* Param);

int on_cti_msg_parse((const unsigned char *)buf, int len,RecvInfo* Param);

int on_cti_msg_recv_func(const char *buf, int len,RecvInfo* Param);
